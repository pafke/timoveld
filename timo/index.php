...
get_header(); ?>
		...
		<section class="content" id="voorstellen-scrollTo">
			...
			<svg class="roundimg" version="1.1" id="Laag_3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
					 width="324px" height="324px" viewBox="0 0 324 324" enable-background="new 0 0 324 324" xml:space="preserve">
				<rect fill="#444444" width="324" height="324"/>
				<g>
				...
				<g>
					...
					<polygon fill="#374D5A" points="230.711,211.066 232.125,224.563 234.324,212.031 	"/>
					...
					<polygon fill="#859BA9" points="234.324,212.031 232.125,224.563 237.859,210.941 	"/>
